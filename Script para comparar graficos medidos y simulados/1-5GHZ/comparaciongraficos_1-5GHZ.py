...
try:
    ntwk_rogers_simulado = rf.Network('S21-Rogers-1-5G.s2p')
except FileNotFoundError:
    print("ERROR: No se encontró 'S21-Rogers-1-5G.s2p'.")
    exit()

try:
    ntwk_fr4_simulado = rf.Network('S21-FR4-1-5G.s2p')
except FileNotFoundError:
    print("ERROR: No se encontró 'S21-FR4-1-5G.s2p'.")
    exit()
...
# --- Título general ---
plt.suptitle('Comparación de Parámetros $|S_{21}|$ a 1.5GHZ (Transmisión)')
