...
# Parámetros físicos del resonador a 1.5GHZ para ROGERS4350B
R_rogers = 18.8530076651997e-3             # Radio para 1.5GHZ
...
# Parámetros físicos del resonador a 1.5GHZ para FR4
R_fr4 = 17.6569183408397e-3                # Radio para 1.5GHZ
...
# Modos de resonancia --> hasta 9GHZ
n_modos = [1,2,3]
...
ntwk_rogers = rf.Network('S21-Rogers-1-5G.s2p')
ntwk_fr4 = rf.Network('S21-FR4-1-5G.s2p')
...
# Filtrar hasta 9 GHz (6 picos para fundamental de 1.5GHZ)
...
print(frecuencias_resonancia_Hz_rogers)
print(epsilon_r_rogers)
...
print(frecuencias_resonancia_Hz_fr4)
print(epsilon_r_fr4)
...
plt.ylabel('εr(f)')
plt.title('ROGERS 4350B vs FR4 a 1.5GHZ')
plt.grid(True)
plt.ylim(3, 5)
