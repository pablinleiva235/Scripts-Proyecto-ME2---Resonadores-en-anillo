...
frecuencias_resonancia_rogers = [1.473143, 2.931298, 4.364726]
...
# --- Datos de FR4 ---
frecuencias_resonancia_fr4 = [1.531859, 3.055646, 4.549100]
...
plt.ylabel('εeff(f)')
plt.title('Cálculo de Permitividad Efectiva (εeff) a 1.5GHZ: ROGERS 4350B vs FR4')
...
plt.xlabel('Frecuencias de resonancia (GHz)')
plt.ylabel('εr(f)')
plt.title('Cálculo de Permitividad Relativa (εr) a 1.5GHZ: ROGERS 4350B vs FR4')
plt.grid(True, which='both', linestyle='--', alpha=0.6)
