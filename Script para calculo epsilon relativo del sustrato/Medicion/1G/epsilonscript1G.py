...
R_rogers = 28.695e-3              # Radio para 1GHZ
...
plt.ylabel('εeff(f)')
plt.title('Cálculo de Permitividad Efectiva (εeff) a 1GHZ: ROGERS 4350B vs FR4')
...
plt.xlabel('Frecuencias de resonancia (GHz)')
plt.ylabel('εr(f)')
plt.title('Cálculo de Permitividad Relativa (εr) a 1GHZ: ROGERS 4350B vs FR4')
plt.grid(True, which='both', linestyle='--', alpha=0.6)
